...
int main(int argc, char* argv[])
{
	...
	failed = !Testee::ObjectTestSuite<int>(
		"int",
		"{\"value\":-4711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<unsigned int>(
		"unsigned int",
		"{\"value\":4711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
...
#if (_SIZEOF_INT8_T + 0)
	failed = !Testee::ObjectTestSuite<std::int8_t>(
		"std::int8_t",
		"{\"value\":-47}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<std::uint8_t>(
		"std::uint8_t",
		"{\"value\":47}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<std::int16_t>(
		"std::int16_t",
		"{\"value\":-4711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<std::uint16_t>(
		"std::uint16_t",
		"{\"value\":4711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<std::int32_t>(
		"std::int32_t",
		"{\"value\":-47114711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<std::uint32_t>(
		"std::uint32_t",
		"{\"value\":47114711}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<float>(
		"float", "{\"value\":3.25}",
		"{\"value\":\"invalid\"}",
		"{\"value\":0.0}",
		"{\"value\":0}").run() || failed;
	...
	failed = !Testee::ObjectTestSuite<bool>(
		"bool",
		"{\"value\":true}",
		"{\"value\":\"invalid\"}",
