...
template void SetMapElements<std::shared_ptr<std::string>, Polymorphic::UnorderedMap>::operator()(const Json::MapBase<std::shared_ptr<std::string>, Polymorphic::UnorderedMap>& map);
