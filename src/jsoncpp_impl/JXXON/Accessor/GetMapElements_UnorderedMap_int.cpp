...
template<>
void GetMapElements<int, Polymorphic::UnorderedMap>::operator()(Json::MapBase<int, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<int, Polymorphic::UnorderedMap>::operator()(Json::MapBase<int, Polymorphic::UnorderedMap>& map) const;
...
template<>
void GetMapElements<std::int64_t, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::int64_t, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<std::int64_t, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::int64_t, Polymorphic::UnorderedMap>& map) const;
#endif
...
template<>
void GetMapElements<std::intmax_t, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::intmax_t, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<std::intmax_t, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::intmax_t, Polymorphic::UnorderedMap>& map) const;
#endif
