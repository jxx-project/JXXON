...
template<>
void GetMapElements<std::shared_ptr<int>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<int>, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<std::shared_ptr<int>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<int>, Polymorphic::UnorderedMap>& map) const;
...
template<>
void GetMapElements<std::shared_ptr<std::int64_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::int64_t>, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<std::shared_ptr<std::int64_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::int64_t>, Polymorphic::UnorderedMap>& map) const;
#endif
...
template<>
void GetMapElements<std::shared_ptr<std::intmax_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::intmax_t>, Polymorphic::UnorderedMap>& map) const
{
...
template void GetMapElements<std::shared_ptr<std::intmax_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::intmax_t>, Polymorphic::UnorderedMap>& map) const;
#endif
