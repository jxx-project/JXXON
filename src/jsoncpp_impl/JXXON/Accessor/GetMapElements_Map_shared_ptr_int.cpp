...
template<>
void GetMapElements<std::shared_ptr<int>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<int>, Polymorphic::Map>& map) const
{
...
template void GetMapElements<std::shared_ptr<int>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<int>, Polymorphic::Map>& map) const;
...
template<>
void GetMapElements<std::shared_ptr<std::int64_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::int64_t>, Polymorphic::Map>& map) const
{
...
template void GetMapElements<std::shared_ptr<std::int64_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::int64_t>, Polymorphic::Map>& map) const;
#endif
...
template<>
void GetMapElements<std::shared_ptr<std::intmax_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::intmax_t>, Polymorphic::Map>& map) const
{
...
template void GetMapElements<std::shared_ptr<std::intmax_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::intmax_t>, Polymorphic::Map>& map) const;
#endif
