...
template<>
GetMapElements<unsigned int, Polymorphic::Map>::GetMapElements(const Json& json) : json(json)
{
}
...
template<>
GetMapElements<std::uint64_t, Polymorphic::Map>::GetMapElements(const Json& json) : json(json)
{
}
...
template<>
GetMapElements<std::uintmax_t, Polymorphic::Map>::GetMapElements(const Json& json) : json(json)
{
}
