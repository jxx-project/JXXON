...
template<>
void GetMapElements<std::shared_ptr<unsigned int>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<unsigned int>, Polymorphic::Map>& map) const
{
...
template<>
GetMapElements<std::shared_ptr<std::uint64_t>, Polymorphic::Map>::GetMapElements(const Json& json) : json(json)
{
}

template<>
void GetMapElements<std::shared_ptr<std::uint64_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::uint64_t>, Polymorphic::Map>& map) const
{
...
template<>
GetMapElements<std::shared_ptr<std::uintmax_t>, Polymorphic::Map>::GetMapElements(const Json& json) : json(json)
{
}

template<>
void GetMapElements<std::shared_ptr<std::uintmax_t>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<std::uintmax_t>, Polymorphic::Map>& map) const
{
