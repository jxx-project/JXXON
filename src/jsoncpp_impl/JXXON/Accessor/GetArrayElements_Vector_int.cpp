...
template<>
void GetArrayElements<int, Polymorphic::Vector>::operator()(Json::ArrayBase<int, Polymorphic::Vector>& array) const
{
...
template void GetArrayElements<int, Polymorphic::Vector>::operator()(Json::ArrayBase<int, Polymorphic::Vector>& array) const;
...
template<>
void GetArrayElements<std::int64_t, Polymorphic::Vector>::operator()(Json::ArrayBase<std::int64_t, Polymorphic::Vector>& array) const
{
...
template void GetArrayElements<std::int64_t, Polymorphic::Vector>::operator()(Json::ArrayBase<std::int64_t, Polymorphic::Vector>& array) const;
#endif
...
template<>
void GetArrayElements<std::intmax_t, Polymorphic::Vector>::operator()(Json::ArrayBase<std::intmax_t, Polymorphic::Vector>& array) const
{
...
template void GetArrayElements<std::intmax_t, Polymorphic::Vector>::operator()(Json::ArrayBase<std::intmax_t, Polymorphic::Vector>& array) const;
#endif
