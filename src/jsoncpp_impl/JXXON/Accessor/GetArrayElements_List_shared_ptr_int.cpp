...
template<>
GetArrayElements<std::shared_ptr<int>, Polymorphic::List>::GetArrayElements(const Json& json) : json(json)
{
}

template<>
void GetArrayElements<std::shared_ptr<int>, Polymorphic::List>::operator()(Json::ArrayBase<std::shared_ptr<int>, Polymorphic::List>& array) const
{
...
template<>
GetArrayElements<std::shared_ptr<std::int64_t>, Polymorphic::List>::GetArrayElements(const Json& json) : json(json)
{
}

template<>
void GetArrayElements<std::shared_ptr<std::int64_t>, Polymorphic::List>::operator()(Json::ArrayBase<std::shared_ptr<std::int64_t>, Polymorphic::List>& array) const
{
...
template<>
GetArrayElements<std::shared_ptr<std::intmax_t>, Polymorphic::List>::GetArrayElements(const Json& json) : json(json)
{
}

template<>
void GetArrayElements<std::shared_ptr<std::intmax_t>, Polymorphic::List>::operator()(Json::ArrayBase<std::shared_ptr<std::intmax_t>, Polymorphic::List>& array) const
{
