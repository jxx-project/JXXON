...
template<>
GetArrayElements<std::shared_ptr<unsigned int>, std::list>::GetArrayElements(const Json& json) : json(json)
{
}
...
template<>
GetArrayElements<std::shared_ptr<std::uint64_t>, std::list>::GetArrayElements(const Json& json) : json(json)
{
}
...
template<>
GetArrayElements<std::shared_ptr<std::uintmax_t>, std::list>::GetArrayElements(const Json& json) : json(json)
{
}
