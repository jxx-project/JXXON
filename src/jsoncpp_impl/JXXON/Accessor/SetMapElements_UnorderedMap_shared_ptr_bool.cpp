...
template void SetMapElements<std::shared_ptr<bool>, Polymorphic::UnorderedMap>::operator()(const Json::MapBase<std::shared_ptr<bool>, Polymorphic::UnorderedMap>& map);
