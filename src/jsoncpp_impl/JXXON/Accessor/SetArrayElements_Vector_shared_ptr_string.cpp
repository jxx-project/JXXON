...
template void SetArrayElements<std::shared_ptr<std::string>, Polymorphic::Vector>::operator()(const Json::ArrayBase<std::shared_ptr<std::string>, Polymorphic::Vector>& array);
