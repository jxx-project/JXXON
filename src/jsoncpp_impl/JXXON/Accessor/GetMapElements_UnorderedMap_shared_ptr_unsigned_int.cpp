...
template<>
void GetMapElements<std::shared_ptr<unsigned int>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<unsigned int>, Polymorphic::UnorderedMap>& map) const
{
...
template<>
void GetMapElements<std::shared_ptr<std::uint64_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::uint64_t>, Polymorphic::UnorderedMap>& map) const
{
...
template<>
void GetMapElements<std::shared_ptr<std::uintmax_t>, Polymorphic::UnorderedMap>::operator()(Json::MapBase<std::shared_ptr<std::uintmax_t>, Polymorphic::UnorderedMap>& map) const
{
