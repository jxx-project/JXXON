...
template<>
void GetMapElements<float, Polymorphic::Map>::operator()(Polymorphic::Map<std::string, float>& map) const
{
...
template<>
void GetMapElements<double, Polymorphic::Map>::operator()(Polymorphic::Map<std::string, double>& map) const
{
