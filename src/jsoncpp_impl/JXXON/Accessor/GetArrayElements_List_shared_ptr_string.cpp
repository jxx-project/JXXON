...
template<>
void GetArrayElements<std::shared_ptr<std::string>, Polymorphic::List>::operator()(Json::ArrayBase<std::shared_ptr<std::string>, Polymorphic::List>& array) const
{
...
template void GetArrayElements<std::shared_ptr<std::string>, Polymorphic::List>::operator()(Json::ArrayBase<std::shared_ptr<std::string>, Polymorphic::List>& array) const;
