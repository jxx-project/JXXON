...
template<>
void GetMapElements<std::shared_ptr<float>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<float>, Polymorphic::Map>& map) const
{
...
template<>
void GetMapElements<std::shared_ptr<double>, Polymorphic::Map>::operator()(Json::MapBase<std::shared_ptr<double>, Polymorphic::Map>& map) const
{
