...
{
	populateArray<std::shared_ptr<int>, std::vector>(array, json.pimpl->value, [](const ::Json::Value::const_iterator& i){return i->asInt();});
}
...
{
	populateArray<std::shared_ptr<std::int64_t>, std::vector>(array, json.pimpl->value, [](const ::Json::Value::const_iterator& i){return i->asInt64();});
}
...
{
	populateArray<std::shared_ptr<std::intmax_t>, std::vector>(array, json.pimpl->value, [](const ::Json::Value::const_iterator& i){return i->asLargestInt();});
}
